...
Inference of player skills for a single tennis match. [(Scala code example)](https://github.com/danielkorzekwa/bayes-scala/blob/master/src/test/scala/dk/bayes/factorgraph/ep/calibrate/fb/TrueSkillOnlineTennisEPTest.scala)
