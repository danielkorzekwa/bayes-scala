...
plot [-25:50][0:0.125] \
((1-w)*linear_gaussian(theta,x,1)*gaussian(theta,prior,sqrt(b)) + w*gaussian(x,0,sqrt(a))*gaussian(theta,prior,sqrt(b)))/Z t 'p(theta) = 1/Z * q(theta)f(x|theta)', \
gaussian(theta,11.83649,sqrt(101.215)) t 'p_approx(theta) = N(11.836,101.215)'
