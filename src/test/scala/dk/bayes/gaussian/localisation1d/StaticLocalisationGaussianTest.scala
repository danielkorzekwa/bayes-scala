...
class StaticLocalisationGaussianTest {
  ...
  @Test def single_observation {
    ...
    assertEquals(1.5, locationPosterior.mu.at(0), 0.001)
    assertEquals(0.5625, locationPosterior.sigma.at(0), 0.001)
  }
  ...
  @Test def two_observations {
    ...
    assertEquals(1.161, locationPosterior2.mu.at(0), 0.001)
    assertEquals(0.346, locationPosterior2.sigma.at(0), 0.001)
  }
