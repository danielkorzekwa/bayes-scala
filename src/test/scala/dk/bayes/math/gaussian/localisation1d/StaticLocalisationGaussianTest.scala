...
class StaticLocalisationGaussianTest {
  ...
  @Test def single_observation ={
    ...
    assertEquals(1.5, locationPosterior.m(0), 0.001)
    assertEquals(0.5625, locationPosterior.v(0,0), 0.001)
  }
  ...
  @Test def two_observations ={
    ...
    assertEquals(1.161, locationPosterior2.m(0), 0.001)
    assertEquals(0.346, locationPosterior2.v(0,0), 0.001)
  }
